...
class AcceptPurchaseRequestViewTests(TestCase):
    def setUp(self):
        ...
        self.accept_purchase_request_view = (
        ...
        url = reverse(
            ...
            kwargs={"purchase_request_id": self.purchase_request.id},
        )
    ...
    def test_accept_purchase_request_with_seller_user(self):
        ...
        self.assertEqual(
            self.purchase_request.state, PurchaseRequest.State.ACCEPTED
        )
    ...
    def test_accept_invalid_purchase_request(self):
        ...
        response = self.accept_purchase_request_view(
            self.accept_purchase_request,
            purchase_request_id=self.purchase_request.id + 1,
        )
